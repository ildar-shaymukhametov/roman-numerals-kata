...
public class UnitTest1
{
    ...
    [Fact]
    public void Converts_300_to_roman_CCC()
    {
    ...
    [Fact]
    public void Converts_500_to_roman_D()
    {
    ...
    [Fact]
    public void Converts_600_to_roman_DC()
    {
        var actual = Converter.ToRoman(600);
        Assert.Equal("DC", actual);
    }

    [Fact]
    public void Converts_700_to_roman_DCC()
    {
    ...
    [Fact]
    public void Converts_900_to_roman_CM()
    {
